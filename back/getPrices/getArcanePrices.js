...
const SAVE_PATH = path.join(__dirname, "..", "pricesData", "arcanePrices.json")
...
async function price() {
    ...
    for (const [baseName, arcane] of Object.entries(items.arcanes)) {
        ...
        const maxRank = arcane.max_rank.toString()
